...
npx concurrently -c "bgBlue.bold,bgMagenta.bold,bgGreen.bold,bgYellow.bold,bgRed.bold,bgCyan.bold,bgWhite.bold,bgBlack.bold,bgBlue" `
    ...
    "npx nest start cart-service" `
    "npx nest start order-service" `
    "npx nest start search-service" `
    "npx nest start wallet-service"
