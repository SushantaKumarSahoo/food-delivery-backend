  ...
  Future<bool> login(String email, String password) async {
    ...
    try {
      ...
      if (token != null) {
        ...
        // Mock FCM token registration (would usually be in a separate service, but putting here for simplicity)
        try {
          final dio = ref.read(apiClientProvider);
          await dio.put('/users/device-token', data: {'fcmToken': 'mock_fcm_token_customer_${DateTime.now().millisecondsSinceEpoch}'});
        } catch (_) {}
