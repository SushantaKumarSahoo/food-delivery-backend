...
class _LoginScreenState extends ConsumerState<LoginScreen> {
  ...
  void _onLogin() async {
    ...
    // Call our backend Auth Provider
    final success = await ref.read(authControllerProvider.notifier).sendOtp('+91$phone');
                  ...
                  builder: (context, ref, child) {
                    ...
                    return ValueListenableBuilder<TextEditingValue>(
                      ...
                      builder: (context, value, child) {
                        final isValid = value.text.trim().length >= 10;
                        return FilledButton(
                          onPressed: (isLoading || !isValid) ? null : _onLogin,
